...
## V2 体验优化（2026-08）
- 主导航重构：首页 / 训练 / 动作 / 历史 / 我的。
- 计划并入训练，身体与力量数据并入“我的”。
- 取消快速记录与 RIR。
- 每组支持完成态、复制、递减组、删除；新增一组默认复制上一组数据。
- 动作级菜单支持讲解、排序、替换、删除。
- 动作库扩充力量动作与有氧动作；有氧以 min 记录。
- 历史新增日历视图。
- 饮食新增每日菜系推荐与“换一批”。
- PWA 禁用页面文字长按选择与双指缩放，强化原生 App 体验。
- 动作循环示意与肌群图使用 TRAIN LOG 自制 SVG，不直接使用来源不明的第三方素材。
- 中文视频讲解位已预留；第三方视频仅在确认开放授权后接入。
