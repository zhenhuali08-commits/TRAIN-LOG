const APP_CACHE='train-log-v25-local';
const MEDIA_CACHE='train-log-media-v25';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/body-front-base.png','./assets/body-back-base.png'];
